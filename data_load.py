...
class BasicPreProcess:
    ...
    def preprocess_gene_expression(self):
        ...
        out_dir = f'Nov8/{self.cancer_type}'
    ...
    def preprocess_cna_data(self):
        ...
        out_dir = f'Nov8/{self.cancer_type}'
        os.makedirs(out_dir, exist_ok=True)
        cna_df.to_csv(f'{out_dir}/cna_df.csv', index=False)
    ...
    def preprocess_methylation_data(self):
        ...
        out_dir = f'Nov8/{self.cancer_type}'
        os.makedirs(out_dir, exist_ok=True)
        df_pivoted.to_csv(f'{out_dir}/meth_pivot.csv', index=False)
    ...
    def preprocess_mutation_data(self):
        ...
        out_dir = f'Nov8/{self.cancer_type}'
        os.makedirs(out_dir, exist_ok=True)
        encoded_df2.to_csv(f'{out_dir}/mut_encoded_df.csv', index=False)

# Example usage:
cancer_preprocessor = BasicPreProcess(cancer_type='lusc')
